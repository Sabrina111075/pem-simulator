...
# 真實報價基準字典 (2303聯電: 125.0, 2609陽明: 63.6)
base_price_map = {
    "2330": 2400.0, "2317": 210.0, "2454": 1400.0, "2303": 125.0, "6770": 26.8,
...
if stock_mode == "熱門標的":
    ...
    stock_code = st.sidebar.text_input("請輸入台股代碼 (例如: 2330, 2609)", value="2609").strip().upper()
    stock_name = stock_name_map.get(stock_code, "")
    display_stock_name = f"{stock_code} {stock_name}".strip()

# 精準匹配基準價，未定標的預設 100.0
