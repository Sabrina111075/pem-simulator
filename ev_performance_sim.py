...
st.caption(f"TAD-AGE Engine V4.1 | Analysis Time: {current_time_str}")
st.markdown("---")
...
m4.metric("System Status / 系統狀態", status_text, delta=status_delta)
...
with col1:
    ...
    ax_t.set_ylabel("Force/Torque", color='gray')
